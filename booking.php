...
if(isset($_POST['book']))
{
    ...
    $plm =$_POST['problem'];
    $charge=$_POST['charge'];
    $condition_arr=array("date"=>$date,"user_id"=>$uid,"worker_id"=>$wid,"book_date"=>$bdate,"book_time"=>$time,"book_problemdetails"=>$plm,"book_charges"=>$charge);

    $sobj->insert("tbl_bookingmaster",$condition_arr);
}
						...
						<div class="col-md-6">
							<div class="box">
                                ...
                                <div class="form-group">
									...
									<button type="submit" name="book" class="btn btn-primary btn-inline">Order  </button>&nbsp; &nbsp; &nbsp; 
