							...
							<table class="job-manager-jobs table table-bordered table-striped">
								<thead>
									<tr>
										...
										<th class="status">Bookdate</th>
										<th class="expires">Time</th>
										<th class="filled">Issue</th>
								...
								<tbody>
									...
									<tr>
                                        ...
                                        <?php 
                                        $condition=array("user_id"=>$row['user_id']);
                                        ...
                                        ?>
										<td class="date"><?php echo $urow['user_name'] ?></td>
										
										<td class="expires"><?php echo $row['book_date']  ?></td>
										<td class="expires"><?php echo $row['book_time']  ?></td>
                                        <td class="expires"><?php echo $row['book_problemdetails']  ?></td>
                                        <td class="expires"><?php echo $row['book_charges']  ?></td>
									</tr>
									<?php  } }?>
