...
if(isset($_POST['changepassword']))
{
   ...
   $result = $sobj->select("tbl_usermaster","*",$condition);

  if($result['0']['user_password'] == $opass)
  {
        if($npass == $cpass)
        {
            if($opass == $npass)
            ...
            {
                $condition=array("user_password"=>$npass);
               $result = $sobj->update("tbl_usermaster",$condition,"user_id",$_SESSION['id']);
               if($result > 0)
               {
						...
						<div class="col-md-6">
							<div class="box">
								...
								<form action="#" method="POST" role="form">
									...
									<button type="submit" name="changepassword" class="btn btn-primary btn-inline">Changepassword</button>&nbsp; &nbsp; &nbsp; 
