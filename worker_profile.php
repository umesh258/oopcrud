					...
					<div class="row">
						<div class="col-md-5">
							<figure class="alignnone">
								<img src="workerimg/<?php echo $result['0']['worker_photo'] ?>" alt="" class="img-circle">
							</figure>
						</div>
						<div class="col-md-6 col-md-offset-1">
							...
							<div class="list">
								<ul>
                                    <?php  if($result['0']['worker_gender'] == "1")
                                            {
                                                $gender = "Male";
                                            }else
                                            {
                                            ...
                                            $condition=array("area_id"=>$result['0']['area_id']);
                                            $aresult = $sobj->select("tbl_area","area_name",$condition);
                                            $condition=array("category_id"=>$result['0']['category_id']);
                                            $cresult = $sobj->select("tbl_category","category_name",$condition);
                                    ?>
									<li><?php echo $result['0']['worker_name'] ?></li>
									<li><?php echo $result['0']['worker_email'] ?></li>
									<li><?php echo $gender ?></li>
									<li><?php echo $result['0']['worker_dob'] ?></li>
									<li><?php echo $result['0']['worker_address'] ?></li>
                                    <li><?php echo $aresult['0']['area_name'] ?></li>
                                    <li><?php echo $cresult['0']['category_name'] ?></li>
                                    <li><?php echo $result['0']['worker_exp'] ?></li>
                                    <li><?php echo $result['0']['worker_aboutme'] ?></li>
                                    <li><?php echo $result['0']['worker_time'] ?></li>
                                    <li><?php echo $result['0']['worker_charge'] ?></li>
						...
						<?php	echo "<a href='worker_edit.php?wid={$result['0']['worker_id']}' class='btn btn-primary'>Edit</a>"; ?>
						</div>
					</div>
